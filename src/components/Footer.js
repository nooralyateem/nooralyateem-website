    ...
    <footer id="contact" className="footer">
      ...
      <div className="footer-main">
        ...
        <div className="footer-mission">
            <p>
              The Prophet ﷺ said, 'The one who cares for an orphan and myself will be together in Paradise like this' [Bukhari]
            </p>
            <p>
              Instill kindness and giving as a way of life in the community — join us in illuminating lives with love and support🤍
            </p>
          </div>
          ...
          <div className="footer-copyright">
            <p>&copy; {currentYear} Noor Al Yateem. Website by Noor Al Yateem.</p>
          </div>
        </div>
